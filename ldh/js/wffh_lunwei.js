...
for(i=0;i<22;i++){
	...
	quotes=new Array
	quotes[1]='<p>已成功订购 伦威保罗新款男士撞色单肩包-套装黑色<font color="#FF0000">√</font></p>'
	quotes[2]='<p>已成功订购 伦威保罗新款男士撞色单肩包-套装蓝色<font color="#FF0000">√</font></p>'
	quotes[3]='<p>已成功订购 伦威保罗新款男士撞色单肩包-套装黑色<font color="#FF0000">√</font></p>'
	var quote=quotes[rand1]
	document.write(quote)
	document.write('<br>');
}
