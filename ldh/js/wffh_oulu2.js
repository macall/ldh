...
for(i=0;i<22;i++){
	...
	quotes=new Array
	quotes[1]='<p>已成功订购 LENWEBOLO男士商务公文包-黑色出行装<font color="#FF0000">√</font></p>'
	quotes[2]='<p>已成功订购 LENWEBOLO男士商务公文包-棕色出行装<font color="#FF0000">√</font></p>'
	quotes[3]='<p>已成功订购 LENWEBOLO男士商务公文包-灰蓝色出行装<font color="#FF0000">√</font></p>'
	var quote=quotes[rand1]
	document.write(quote)
	document.write('<br>');
}
