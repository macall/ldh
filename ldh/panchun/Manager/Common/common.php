...
function getstats($stats)
{
  ...
  {
    case "待处理":
	$str="<span style='color:red;line-height:22px'>待处理</font>";
	break;
	case "询问中":
	$str="<span style='color:blue;line-height:22px'>询问中</font>";
	break;
	case "有效单":
	$str="<span style='color:#FF00FF;line-height:22px'>有效单</font>";
	break;
	case "待发货":
	$str="<span style='color:#F4A460;line-height:22px'>待发货</font>";
	break;
	case "发货中":
	$str="<span style='color:#DC143C;line-height:22px'>发货中</font>";
	break;
	case "已发货":
	$str="<span style='color:#698B22;line-height:22px'>已发货</font>";
	break;
	case "成交":
	$str="<span style='color:#009ACD;line-height:22px'>成交</font>";
	break;
	default:
	$str="<span style='color:red;line-height:22px'>待处理</font>";
	break;
...
function getJinduinfo($id,$key){
	if ($id) {
		$info=M('Honorrulls')->where('id = '.$id)->find();
		if ($key) {
			return $info[$key];
		}else{
			return $info;
