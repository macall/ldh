...
for(i=0;i<22;i++){
	...
	quotes=new Array
	quotes[1]='<p>已成功订购 袋鼠王者男包真皮商务休闲包-经典黑<font color="#FF0000">√</font></p>'
	quotes[2]='<p>已成功订购 袋鼠王者男包真皮商务休闲包-商务棕<font color="#FF0000">√</font></p>'
	quotes[3]='<p>已成功订购 袋鼠王者男包真皮商务休闲包-时尚蓝<font color="#FF0000">√</font></p>'
	var quote=quotes[rand1]
	document.write(quote)
	document.write('<br>');
}
