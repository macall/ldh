...
/**
    ...
    function excel(){//导出Excel
        ...
        $xlsData  = $xlsModel->Field('id,uname,product,status,tel,province,city,dist,address,create_time,message,remark,url')->select();
         foreach ($xlsData as $k => $v)
        {
		    $xlsData[$k]['address']=$xlsData[$k]['province'].$xlsData[$k]['city'].$xlsData[$k]['dist'].$xlsData[$k]['address'];
